...
class StudentAdmissionForm(FlaskForm):
    # students info
    student_name_english = StringField('Student Name (English)', validators=[DataRequired(), Length(max=100)])
    student_name_bangla = StringField('Student Name (বাংলা)', validators=[Optional(), Length(max=100)])
    ...
    father_name_bangla = StringField('Father Name (বাংলা)', validators=[Optional(), Length(max=100)])
    father_mobile = StringField('Father Mobile No', validators=[DataRequired(), Length(max=15)])
    father_nid = StringField('Father NID/Passport', validators=[Optional(), Length(max=20)])
    # mother info 
    mother_name_english = StringField('Mother Name (English)', validators=[DataRequired(), Length(max=100)])
    mother_name_bangla = StringField('Mother Name (বাংলা)', validators=[Optional(), Length(max=100)])
    mother_mobile = StringField('Mother Mobile No', validators=[DataRequired(), Length(max=15)])
    mother_nid = StringField('Mother NID/Passport', validators=[Optional(), Length(max=20)])
    ...
    relationship = StringField('Relationship', validators=[Optional(), Length(max=50)])
    guardian_mobile = StringField('Guardian Mobile', validators=[Optional(), Length(max=15)])
    guardian_occupation = StringField('Occupation', validators=[Optional(), Length(max=50)])
